...
class contaPremium extends contaPoupança {
  constructor(value, atualizarJuros) {
    super(value, atualizarJuros);
  }
  atualizarJuros() {
    return console.log(
      `Agora você tem R$${
        ...
        this.value * 1.2 - this.value
      } por conta dos juros`
    );
  }
}

let premiumAcc = new contaPremium();
console.log(premiumAcc.atualizarJuros());
